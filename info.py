...
BOT_TOKEN = environ.get('BOT_TOKEN', "7355568133:AAGL3tYLV3qlKnor83ciSChp4kFKjmb_bVs")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '655594746 7255612720').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002213918949').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002213918949') # request channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Scarlett_Auto_Bot")
BOT_NAME = environ.get("BOT_NAME", "Scarlet")
